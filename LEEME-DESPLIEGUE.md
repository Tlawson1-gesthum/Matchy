# Voral — cómo publicar esto en internet (sin programar)
...
2. Creá un repositorio nuevo, por ejemplo `voral`.
...
2. **Add New → Project** → elegí el repositorio `voral` que acabás de subir.
...
4. Apretá **Deploy**. En 1-2 minutos Vercel te da un link (algo como `voral.vercel.app`) — esa es tu web real, ya funcionando.
...
Cuando quieras usar un dominio como `voral.com.ar`, lo comprás en NIC Argentina y lo conectás desde Vercel → Project Settings → Domains. Te guío en ese momento si querés.
