...
export const metadata = { title: 'Términos y condiciones | Voral' };
  ...
  return (
    <div>
      ...
      <main className="container" style={{ maxWidth: 760 }}>
        ...
        <h2>1. Qué es Voral</h2>
        <p>
          Voral es operado por Tomas Oliver Lawson, CUIL 20-34896158-7, con domicilio en Centenario 2595,
          Posadas, provincia de Misiones, Argentina.
        </p>
        <p>
          Voral es una plataforma de intermediación que pone en contacto a personas que buscan empleo en el rubro
          gastronómico con locales de Posadas y alrededores que ofrecen vacantes. Voral facilita el contacto: no
        ...
        <p>
          Cada usuario es responsable por la veracidad de los datos que carga. Voral realiza una verificación
        ...
        <p>
          Voral no verifica antecedentes laborales, títulos, certificados ni referencias. Tampoco garantiza que
        ...
        <p>
          Voral no verifica la veracidad de lo que declara cada persona, y ningún cálculo automático puede
        ...
        <p>
          ...
          Contrato de Trabajo prohíbe cualquier tipo de discriminación entre trabajadores. Voral da de baja los
        ...
        <ul>
          ...
          <li>No utilizar Voral para cometer fraude, estafas, trata de personas, explotación laboral ni ningún
        ...
        <p>
          El incumplimiento habilita a Voral a dar de baja la cuenta y las vacantes, sin perjuicio de las
        ...
        <p>
          Voral puede ofrecer funcionalidades pagas dirigidas exclusivamente a locales, como destacar vacantes o
        ...
        <h2>11. Alcance de la responsabilidad de Voral</h2>
        <p>
          Voral presta un servicio de puesta en contacto. Su obligación se limita a mantener la plataforma en
        ...
        <p>En particular, Voral no responde por:</p>
        <ul>
          ...
          <li>El resultado de los procesos de selección. Voral no garantiza que una postulación derive en una
          ...
          Voral, incluyendo caídas de los proveedores de infraestructura, fuerza mayor o caso fortuito.</li>
        </ul>
        <p>
          El orden de compatibilidad y el resumen que acompaña a cada candidato son herramientas orientativas de
          lectura. Voral no responde por las decisiones de selección que tome el empleador, que son suyas y deben
        ...
        <p>
          ...
          autoridad administrativa o judicial competente. Voral puede colaborar aportando la información de la
        ...
        <p>
          ...
          los usuarios, ni exime a Voral de responder por los incumplimientos que le sean directamente
          imputables.
        </p>
        ...
        <p>
          ...
          panel, o escribiéndonos. Voral puede
