...
const encabezadosSeguridad = [
  // Impide que otro sitio muestre Voral dentro de un marco para engañar con clics
  { key: 'X-Frame-Options', value: 'DENY' },
  { key: 'Content-Security-Policy', value: "frame-ancestors 'none'" },
  // Impide que el navegador interprete un archivo como algo distinto de lo que es
  { key: 'X-Content-Type-Options', value: 'nosniff' },
  // No revela direcciones completas a otros sitios al salir desde Voral
  { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
  // Voral no usa cámara, micrófono, ubicación ni pagos: se bloquean
